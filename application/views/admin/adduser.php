			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li class="current">
							<a href="<?php echo base_url() ?>office/addnews" title="">Tambah User</a>
						</li>
					</ul>
				</div>
				<!-- /Breadcrumbs line -->
					...
					<div class="col-md-12">
						<div class="widget box">
							...
							<div class="widget-content">
								<?php if($this->session->flashdata('suksesuser')){ ?>
								<div class="alert alert-info fade in">
									<i class="icon-remove close" data-dismiss="alert"></i>
									<?php echo $this->session->flashdata('suksesuser'); ?>
								</div>
								<?php } ?>
								<?php if($this->session->flashdata('gagaluser')){ ?>
								<div class="alert alert-danger fade in">
									<i class="icon-remove close" data-dismiss="alert"></i>
									<?php echo $this->session->flashdata('gagaluser'); ?>
								</div>
								<?php } ?>
								<form class="form-horizontal row-border" action="<?php echo base_url(); ?>index.php/office/adduser" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-md-10"><input type="text" name="password" class="form-control"></div>
									</div>
									<div class="form-group">
