			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li class="current">
							<a href="<?php echo base_url() ?>office/listreqdonatur" title="">Daftar Permintaan Donatur</a>
						</li>
					</ul>
				</div>
				<!-- /Breadcrumbs line -->
				...
				<div class="page-header">
					<div class="page-title">
						<h3>Daftar Permintaan Donatur</h3>
						<span></span>
					</div>
				</div>
				<div class="row">
								...
								<table class="table table-striped table-bordered table-hover table-checkable datatable">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php $date= new DateTime($row->tglpengiriman); echo $date->format('d/m/Y'); ?></td>
											...
											<td><a href="<?php echo base_url(); ?>index.php/office/checkdonatur/<?php echo $row->iddonatur; ?>" class="icon-check"></a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>index.php/office/deletereqdonatur/<?php echo $row->iddonatur; ?>" class="icon-remove"></a></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
