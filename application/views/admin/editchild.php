			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li class="current">
							<a href="<?php echo base_url() ?>office/<?php echo $anak->noinduk; ?>" title="">Edit Data Anak</a>
						</li>
					</ul>
				</div>
				<!-- /Breadcrumbs line -->
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Form Edit Data Anak</h4>
							</div>
							<div class="widget-content">
								...
								<?php } ?>
								<form class="form-horizontal row-border" action="<?php echo base_url(); ?>index.php/office/submitedichild" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-md-2 control-label">No Induk :</label>
										<div class="col-md-10"><input type="text" name="noinduk" class="form-control" value="<?php echo $anak->noinduk; ?>">
											<input type="hidden" name="noinduk2" class="form-control" value="<?php echo $anak->noinduk; ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Nama :</label>
										<div class="col-md-10"><input type="text" name="nama" class="form-control" value="<?php echo stripslashes($anak->nama); ?>"></div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">TTL :</label>
										<div class="col-md-10"><input type="text" name="ttl" class="form-control" value="<?php echo stripslashes($anak->ttl); ?>"></div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Orang Tua :</label>
										
											<div class="col-md-5">
												<input type="text" name="ayah" class="form-control" value="<?php echo stripslashes($anak->ayah); ?>"><span class="help-block">Nama Ayah</span>
											</div>
											<div class="col-md-5">
												<input type="text" name="ibu" class="form-control" value="<?php echo stripslashes($anak->ibu); ?>"><span class="help-block">Nama Ibu</span>
											</div>
										
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Alamat:</label>
										<div class="col-md-10"><textarea rows="3" cols="5" name="alamat" class="form-control"><?php echo stripslashes($anak->alamat); ?></textarea></div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Keterangan :</label>
										<div class="col-md-10">
										<textarea rows="3" cols="5" name="keterangan" class="form-control"><?php echo stripslashes($anak->keterangan); ?></textarea></div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Foto :</label>
										<div class="col-md-10">
											<input type="file" name="foto" data-style="fileinput">
											<span class="help-block">* Boleh dikosongkan bila tidak ingin diganti.</span>
										</div>
										<?php if($anak->foto!=''){ ?>
										<div class="col-md-6 col-md-push-3">
											<img src="<?php echo base_url() ?>content/anak/<?php echo $anak->foto; ?>" class="img-responsive img-thumbnail">
										</div>
										<?php } ?>
									</div>
