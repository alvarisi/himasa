			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li class="current">
							<a href="<?php echo base_url() ?>office/addnews" title="">Tambah Berita</a>
						</li>
					</ul>
				</div>
				<!-- /Breadcrumbs line -->
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Form Tambah Berita</h4>
							</div>
							<div class="widget-content">
								...
								<?php } ?>
								<form class="form-horizontal row-border" action="<?php echo base_url(); ?>index.php/office/addnews" method="post" enctype="multipart/form-data">
